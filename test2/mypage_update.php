...
$stmt = $pdo->prepare(
    'UPDATE profile
    SET u_name=:u_name,birthday=:birthday,company=:company,position=:position,industry_category=:industry_category,function_category=:function_category,resume=:resume,introduction=:introduction
    where u_id=:u_id
    ');
